...
export default function ExerciseCard(props) {
  ...
  return (
    <div className='flex flex-col p-4 rounded-md gap-4 bg-slate-950 sm:flex-wrap'>
        ...
        <div className='grid grid-cols-2 sm:grid-cols-4 sm:place-items-center gap-2'>
            {['reps','rest','tempo'].map(info =>{
                return(
                    <div key={info} className='flex flex-col p-2 rounded border-[1.5px] border-solid border-slate-400 w-full'>
